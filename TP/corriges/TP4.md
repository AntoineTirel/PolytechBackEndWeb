...
## Retours pour l'ensemble de la promotion

Les notes sont globalement bonnes, la moyenne pour les questions est de 1,77/3 en prenant en compte toute la promotion.

Elle monte toutefois à 2,1 si l'on exclut les non rendus.

Les notes de la partie code sont toutes augmentées puisque j'avais fourni une base défectueuse, la moyenne monte à 1,8/2 (en excluant les non-rendus).
