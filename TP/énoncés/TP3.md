...
Pour corriger l'erreur, reportez-vous au message ainsi qu'aux principes SOLID : la classe Pokemon du package Entity dépend du Type du package Models, ce qui ne respecte pas les principes de séparation en couche.
...
# Bonus
> Cette partie peut être réalisée avec un outil d'aide d'IA type copilot/ChatGPT/Gemini/Claude.
